...
import { LeadProLayout, RouteView } from '@core/home';
import { Exception404 } from '@core/views';
...
const AsyncGridPanelComponent = defineAsyncComponent(
  () => import('@core/components/grid-panel/index.vue'),
);
/**
 * 系统 layout 路由，需要登录
 */
